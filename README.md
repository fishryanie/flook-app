...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">About Flex App</a>
      <ul>
        <li><a href="#about-the-project">Live demo</a></li>
    ...
    <li><a href="#feature-app">Feature App</a></li>
    <li><a href="#contributors">Contact</a></li>
    <li><a href="#ussage">Contact</a></li>

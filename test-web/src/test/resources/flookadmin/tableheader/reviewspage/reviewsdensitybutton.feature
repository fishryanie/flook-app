Feature: Features in the density button of the reviews page

  @AdminWeb
  Scenario: Verify that when the density button in the reviews page is clicked it will display the full component
  ...
  @AdminWeb
  Scenario Outline: Verify that reviews display modes are working correctly
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to reviews management page
    And I click on the density button in table header

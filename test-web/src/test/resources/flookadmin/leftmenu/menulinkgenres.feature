#Xác minh các đường link menu trong trang Thể loại là chính xác
Feature: The features on left menu in Genres management page

    #Xác minh rằng link dẫn đến trang Thống kê trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Dashboard page link in the Genres page are available
        #Bước 1: Mở website.
    ...
    #Xác minh rằng link dẫn đến trang Người dùng trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the User page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Vai trò trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Roles page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Truyện trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Ebooks page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Tác giả trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Authors page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Chapters trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Chapters page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Đánh giá trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Reviews page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Bình luận trên menu của trang Thể loại là chính xác.
    @AdminWeb
    Scenario: Verify that the Comments page link in the Genres page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"

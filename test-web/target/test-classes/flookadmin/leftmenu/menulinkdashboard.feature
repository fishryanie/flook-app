#Xác minh các đường link menu trong trang Thống kê là chính xác
Feature: The features on left menu in dashboard page

    #Xác minh rằng link dẫn đến trang Người dùng trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the User page link in the Dashboard page are available
        #Bước 1: Mở website.
        ...
        #Bước 3: Điều hướng sang trang thống kê.
    ...
    #Xác minh rằng link dẫn đến trang Vai trò trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Role page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Truyện trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Ebooks page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Tác giả trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Authors page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Thể loại trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Genres page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Chapters trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Chapters page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Đánh giá trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Reviews page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"
    ...
    #Xác minh rằng link dẫn đến trang Bình luận trên menu của trang Thống kê là chính xác.
    @AdminWeb
    Scenario: Verify that the Comments page link in the Dashboard page are available
        #Bước 1: Mở website.
        Given I open the user website
        #Bước 2: Đăng nhập với tài khoản "huyhdang" và mật khẩu "Admin1@113355".
        When I login with the username "huyhdang" and the password "Admin1@113355"

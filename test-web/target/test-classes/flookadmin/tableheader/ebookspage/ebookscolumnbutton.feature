Feature: Features in the column button of the ebooks page

  @AdminWeb
  Scenario: Verify that when the column button in the ebooks page is clicked it will display the full component
  ...
  @AdminWeb
  Scenario Outline: Verify that when entering a keyword in ebooks page column box search box, a list of checkboxes matching the keyword will be returned
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to ebooks management page
    And I click on the column button in table header
  ...
  @AdminWeb
  Scenario: Verify that clicking ebooks page hide all button will deselect all checkboxes and hide all columns
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to ebooks management page
    And I click on the column button in table header
  ...
  @AdminWeb
  Scenario: Verify that clicking ebooks page show all button will deselect all checkboxes and hide all columns
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to ebooks management page
    And I click on the column button in table header
  ...
  @AdminWeb
  Scenario Outline: Verify that ebooks page column box hides and shows the correct column
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to ebooks management page
    And I click on the column button in table header

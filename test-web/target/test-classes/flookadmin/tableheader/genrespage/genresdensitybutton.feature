Feature: Features in the density button of the genres page

  @AdminWeb
  Scenario: Verify that when the density button in the genres page is clicked it will display the full component
  ...
  @AdminWeb
  Scenario Outline: Verify that genres display modes are working correctly
    Given I open the user website
    When I login with the username "huyhdang" and the password "Admin1@113355"
    And I navigate to genres management page
    And I click on the density button in table header
